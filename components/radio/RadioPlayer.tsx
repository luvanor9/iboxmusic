...
export function RadioPlayer() {
  ...
  return (
    ...
    >
      ...
      <a
        href={`https://wa.me/5562994447893?text=${encodeURIComponent('🎵 Olá! Quero pedir uma música na IBOX MUSIC: ')}`}
        target="_blank"
        ...
        onMouseEnter={e => {
          ...
          (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(37,211,102,0.60)';
        }}
        onMouseLeave={e => {
